...
package string _clockTypeName(ClockType clockType)
{
...
// used in MonoTimeImpl
package size_t _clockTypeIdx(ClockType clockType)
{
    final switch (clockType)
    {
...
@safe:
    ...
    /++
      ...
      +/
    static @property MonoTimeImpl currTime() @safe nothrow @nogc
    {
        if (ticksPerSecond == 0)
        {
        ...
        return MonoTimeImpl!clockType(core.time.getCurrMonoTime!(MonoTimeImpl, clockType)());
    }
...
package immutable long[__traits(allMembers, ClockType).length] _ticksPerSecond;
...
deprecated:
    ...
    {
        return core.time.currSystemTick();
    }
